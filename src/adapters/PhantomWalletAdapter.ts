...
// @TEMP - use this global instead of this._wallet.isConnected
let _phantomConnected: boolean = false;
        ...
        try {
          await new Promise<void>((resolve, reject) => {
            const connect = () => {
              ...
              _phantomConnected = true;
              resolve();
            };

            wallet._handleDisconnect = (...args: unknown[]) => {
              _phantomConnected = false;
              wallet.off('connect', connect);
